...
//Register New User
export const register = ({ firstname,lastname,phone,address, email, password }) => (dispatch) => {
  // Headers
  const headers = {
    headers: {
  ...
  // Request body
  const body = JSON.stringify({ firstname,lastname,phone,address, email, password });
